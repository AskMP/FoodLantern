            ...
            <div class="row">
                <aside class="col-md-2 col-sm-3">
                    <nav class="h5a-sidebar affix">
                        <ul class="nav h5a-sidenav nav-list accordian">
                            ...
                            <li data-toggle="collapse" data-target="#nav-recipe">
                                <a>Recipes</a>
                                <ul id="nav-recipe" class="nav nav-list collapse">
                                    <li>
                                        <a href="#recipe-overview">Overview</a>
                                    </li>
                                    <li>
                                        <a href="#recipe-attributes">Attributes</a>
                                    </li>
                                    <li>
                                        <a href="#recipe-methods">Methods</a>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="col-md-10 col-sm-9">
                    <article id="Introduction">
                        <h2>Introduction</h2>
                        <div id="introduction-overview" class="panel panel-primary">
                            <h3 class="panel-heading">About the Project</h3>
                        ...
                        <div id="introduction-overview" class="panel panel-warning">
                            <h3 class="panel-heading">Usage</h3>
                            <div class="panel-body">
                                <p>For the general usage of the API, you use the base URL of <code>http://cttoronto.cloudapp.net/api/</code> along with the method below.</p>
                                <p>Most methods require a variable such as an ID to be passed which is represented using curly braces <code>{</code> and <code>}</code>. Any optional parameters will be encased with square brackets <code>[</code> and <code>]</code>.</p>
                                <p>The response from the server will always be a JSON object with 2 elements; a <code>_meta</code> variable that contains details about the request submitted and a <code>result</code> variable that contains the resulting response to the request.</p>
                            </div>
                            <div class="panel-footer">
                                <h4 data-toggle="collapse" data-target="#example-usage">Live Example: <code>http://cttoronto.cloudapp.net/api/games</code></h4>
                                <div class="collapse" id="example-usage" data-uri="games">
                                    <pre></pre>
                                </div>
                            </div>
                        </div>
                    ...
                    <article id="game">
                        ...
                        <div id="game-overview" class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <p>Each environment of the Forage contains a variable called <code>game</code> that contains a keyed list of active games.</p>
                                ...
                                <div id="game-attributes" class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <dl>
                                            ...
                                            <dd>An array of all the resource available within recipes associated to the game instance.</dd>
                            ...
                            <div class="col-md-9">
                                <div id="game-methods" class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#game-methods-join"><span class="label label-success">GET</span> <code>/games/join/{_id}</code><span class="label label-warning pull-right">Draft</span></div>
                        ...
                        <div class="row">
                                ...
                                <div id="lantern-attributes" class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <dl>
                                            ...
                                            <dd>
                                                <dl>
                                                    Any <a href="#resource">resources</a> that are associated to the lantern. There may be multiple resources available and therefore even 1 resource will be listed as and array item.
                                                    <dt><code>resource_id</code> <small><em>(String)</em></small></dt>
                                                    <dd>The unique databse ID given by the MongoDB server that references the resource type.</dd>
                                                    <dt><code>current</code> <small><em>(Number)</em></small></dt>
                                                    <dd>The amount of the resource available at the lantern at the time of query.</dd>
                                                    <dt><code>max</code> <small><em>(Number)</em></small></dt>
                                                    <dd>The total amount of the resource that can be available at the lantern.</dd>
                                                </dl>
                                            </dd>
                            ...
                            <div class="col-md-9">
                                <div id="lantern-methods" class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#lantern-methods-list"><span class="label label-success">GET</span> <code>/lanterns</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="lantern-methods-list">
                                                <p>Returns a list of lanterns for the game the user is within.</p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#lantern-methods-details"><span class="label label-success">GET</span> <code>/lanterns/{_id}</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="lantern-methods-details">
                                                <p>Returns the lantern information.</p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#lantern-methods-capture"><span class="label label-success">GET</span> <code>/lanterns/{_id}/capture</code><span class="label label-danger pull-right">Incomplete</span></div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#lantern-methods-release"><span class="label label-success">GET</span> <code>/lanterns/{_id}/release</code><span class="label label-danger pull-right">Incomplete</span></div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#lantern-methods-renew"><span class="label label-success">GET</span> <code>/lanterns/{_id}/renew</code><span class="label label-danger pull-right">Incomplete</span></div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body collapse" id="lantern-methods-drain">
                                                <p>Reduce the quantity of a specific resource of the lantern currently captured by the player.</p>
                                                <p>The <code>resource:_id</code> attribute comes from the array item of the <a href="#resource">resource</a> collected and must be a valid ID of the lantern that the player is currently occupying.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <article id="resource">
                        <h2>Recipes</h2>
                        <div id="recipe-overview" class="panel panel-warning">
                            <h3 class="panel-heading">Overview</h3>
                            <div class="panel-body">
                                <p>The goal of the game is to collect enough resources to complete a recipe.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div id="recipe-attributes" class="panel panel-success">
                                    <h3 class="panel-heading">Attributes</h3>
                                    <div class="panel-body">
                                        <dl>
                                            <dt><code>_id</code> <small><em>(String)</em></small></dt>
                                            ...
                                            <dt><code>game_id</code> <small><em>(String)</em></small></dt>
                                            <dd>The unique database ID of the game the recipe is associated to.</dd>
                                            <dt><code>name</code> <small><em>(String)</em></small></dt>
                                            <dd>Human readable name of the resource.</dd>
                                            <dt><code>snipped</code> <small><em>(String)</em></small></dt>
                                            <dd>An extra bit of content that can be associated as an aside or non-important context.</dd>
                                            <dt><code>description</code> <small><em>(String)</em></small></dt>
                                            <dd>Long description of the recipe, this is likely a long description that can contain hyperlinks to external resources.</dd>
                                            <dt><code>image_uri</code> <small><em>(String)</em></small></dt>
                                            <dd>An external image resource that can be used to showcase how the recipe will look upon completion.</dd>
                                            <dt><code>resources</code> <small><em>(Array)</em></small></dt>
                                            <dd>An array of the resources required for making the recipe.</dd>
                            ...
                            <div class="col-md-9">
                                <div id="recipe-methods" class="panel panel-info">
                                    <h3 class="panel-heading">Methods</h3>
                                    <div class="panel-body">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#resources-methods-list"><span class="label label-success">GET</span> <code>/recipes</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="resources-methods-list">
                                                <p>Returns a list of recipes available within the game the player is in.</p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#resources-methods-details"><span class="label label-success">GET</span> <code>/recipes/{_id}</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="resources-methods-details">
                                                <p>Returns the recipe information.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div id="resource-methods" class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#resources-methods-list"><span class="label label-success">GET</span> <code>/resources</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="resources-methods-list">
                                                <p>Returns a list of resources available within the game the player is in.</p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#resources-methods-details"><span class="label label-success">GET</span> <code>/resources/{_id}</code><span class="label label-warning pull-right">Draft</span></div>
                                            <div class="panel-body collapse" id="resources-methods-details">
                    ...
                    <article id="player">
                        <h2>Players</h2>
                        <div id="player-overview" class="panel panel-warning">
                            <h3 class="panel-heading">Overview</h3>
                            <div class="panel-body">
                                <p>Each player within the game has an account that they must register for. The registration process will create a database item that will accumulate points and resources.</p>
                                <p>Each API request must be done via a call using the same session (may change to session key within the header).
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div id="player-attributes" class="panel panel-success">
                                    <h3 class="panel-heading">Attributes</h3>
                                    <div class="panel-body">
                                        <dl>
                                            <dt><code>_id</code> <small><em>(String)</em></small></dt>
                                            <dd>The unique database ID given by the MongoDB server. This is used when referencing the resource in any API call.</dd>
                                            <dt><code>given_name</code> <small><em>(String)</em></small></dt>
                                            <dd>Often first name of the player.</dd>
                                            <dt><code>family_name</code> <small><em>(String)</em></small></dt>
                                            <dd>Often the last name of the player.</dd>
                                            <dt><code>email</code> <small><em>(String)</em></small></dt>
                                            <dd>The unique personal identifier used for login.</dd>
                                            <dt><code>password</code> <small><em>(String)</em></small></dt>
                                            <dd>The security key used to login. <span class="label label-danger">Inaccessible</span></dd>
                                            <dt><code>status</code> <small><em>(Number)</em></small></dt>
                                            <dd>Whether the player is active or disabled</dd>
                                            <dt><code>is_admin</code> <small><em>(Number)</em></small></dt>
                                            <dd>Internally used to determine the access of the player. <span class="label label-danger">Only shown if valid</span></dd>
                                            <dt><code>score</code> <small><em>(Number)</em></small></dt>
                                            <dd>The point value that the player has accumulated.</dd>
                                            <dt><code>resources</code> <small><em>(Array)</em></small></dt>
                                            <dd>A list of resources that the player has accumulated.</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div id="player-methods" class="panel panel-info">
                                    <h3 class="panel-heading">Methods</h3>
                                    <div class="panel-body">
                                        <div class="panel panel-default" id="player-methods-loginMethod">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#player-methods-login"><span class="label label-primary">POST</span> <code>/players/login</code><span class="label label-warning pull-right">draft</span></div>
                                            <div class="panel-body collapse" id="player-methods-login">
                                                <p>Creates a session using the supplied email and password.</p>
                                                <dl>
                                                    <dt><code>@param:email</code> <small>(String)</small></dt>
                                                    <dd>The email address of the player.</dd>
                                                    <dt><code>@param:password</code> <small>(String)</small></dt>
                                                    <dd>The password of the player.</dd>
                                                </dl>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#player-methods-list"><span class="label label-success">GET</span> <code>/players/logout</code><span class="label label-warning pull-right">draft</span></div>
                                            <div class="panel-body collapse" id="player-methods-list">
                                                <p>Logs the player session out.</p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default" id="player-methods-registerMethod">
                                            <div class="panel-heading" data-toggle="collapse" data-target="#player-methods-register"><span class="label label-primary">POST</span> <code>/players/register</code><span class="label label-warning pull-right">draft</span></div>
                                            <div class="panel-body collapse" id="player-methods-register">
                                                <p>Registers a new player to the database and creates a new session them into a session</p>
                                                <dl>
                                                    <dt><code>@param:login</code> <small>(String)</small></dt>
                                                    <dd>The email address of the player.</dd>
                                                    <dt><code>@param:password</code> <small>(String)</small></dt>
                                                    <dd>The password of the player.</dd>
                                                    <dt><code>@optional:given_name</code> <small>(String)</small></dt>
                                                    <dd>First name of the player (highly recommended for better UX).</dd>
                                                    <dt><code>@optional:family_name</code> <small>(String)</small></dt>
                                                    <dd>Last name of the player (highly recommended for better UX).</dd>
                                                </dl>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            (function () {
                ...
                var panels = document.getElementsByClassName('panel'),
                    examples = document.querySelectorAll('[id^="example-"]'),
                    populateExamples = function (index) {
                        index = index || 0;
                        $.ajax('/api/' + examples[index].getAttribute('data-uri'))
                            .then(function (response) {
                                examples[index].querySelector('pre').innerHTML = JSON.stringify(response, null, 4);
                                index += 1;
                                if (index < examples.length) {
                                    populateExamples(index);
                                }
                            });
                    },
                ...
                for (i = 0; i < panels.length; i += 1) {
                    ...
                    for (d = 0; d < dataObj.terms.length; d += 1) {
                        ...
                        dataObj.terms[d].setAttribute('data-target', '#' + panels[i].getAttribute('id') + '-' + (dataObj.terms[d].querySelector('code').textContent).replace(/@|\:/gi, ''));
                        
                        // Set the ID and collapsed class of the definition
                        dataObj.definitions[d].setAttribute('class', 'collapse');
                        dataObj.definitions[d].setAttribute('id', panels[i].getAttribute('id') + '-' + (dataObj.terms[d].querySelector('code').textContent).replace(/@|\:/gi, ''));
                    }
                }
