...
(function () {
    ...
    var Forage; // Global object assigned to the prime
    ...
    SocketServer = function () {
        ...
        this.Administrator = require('./sockets/forage.admin');
        ...
        this.initialize = function () {
            ...
            Forage.notify('Initializing the Socket Server');
        ...
        this.beginSocketServer = function () {
            ...
            if (self.io === null) {
                ...
                self.io = io.listen(Forage.HTTPServer.requests, { log: Forage.settings.debug });
...
//                        adminConnection.getLanternsList();
        ...
        this.addNewPlayer = function (socket) {
            ...
            if (!Forage.players[socket.id]) {
                // Set the player to the prime's player list using it's ID as an index
                Forage.players[socket.id] = new Forage.Player(socket, 'socket');
                deferred.resolve(Forage.players[socket.id]);
            } else {
                deferred.reject();
            }
        ...
        this.addAdministratorListeners = function (admin) {
            ...
            admin.socket.on('playerList', function () {
                admin.socket.emit('players', Forage.playerList());
            });
            admin.socket.on('lanternList', function () {
                admin.socket.emit('lanterns', Forage.lanternList());
            });
            admin.socket.on('administratorList', function () {
                admin.socket.emit('administrators', Forage.adminList());
            });
        ...
        this.disconnectSocket = function (socket) {
            ...
            if (self.players[socket.id]) {
                ...
                delete Forage.players[socket.id];
            }
