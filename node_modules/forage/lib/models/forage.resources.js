...
(function () {
    ...
    resources = function () {
        ...
        this.Resource = require('../classes/forage.resource');
        this.resources = {};
        ...
        this.loadAll = function (resources, index) {
            ...
            if (index === resources.length) {
                ...
                Forage.notify('Loading resource ' + (index + 1) + ' of ' + resources.length);
        ...
        this.load = function (resourceData) {
            ...
            Forage.notify('Added resource ' + newResource.name + ' to game as ID: ' + newResource._id);
