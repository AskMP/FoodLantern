...
(function () {
    ...
    HTTPServer = function (settings) {
        ...
        this.initialize = function () {
            ...
            Forage.notify('Initializing the HTTP Server');
            ...
            self.router.set('views', Forage.settings.htdocs + '/views');
            self.router.set('view engine', 'html');
            self.router.set('layout', Forage.settings.htdocs + '/layouts/default_layout');
            
            // For some files, like the base index, there is only a static website
            self.router.use(serveStatic(Forage.settings.htdocs));
            ...
            self.router.use(session({
                store: new MongoStore({
                    db: Forage.settings.db
                }),
                secret: Forage.settings.secret
            }));
            ...
            self.requests = self.requests.listen(Forage.settings.port);
        ...
        this.loadRoutes = function () {
            ...
            // HTTP based routes
            self.routes.http = require('./routes/forage.routes.http');
            
            // API based routes
            self.routes.api = {
                games   : require('./routes/forage.routes.api.games'),
                players : require('./routes/forage.routes.api.players'),
                recipes : require('./routes/forage.routes.api.recipes'),
                lanterns : require('./routes/forage.routes.api.lanterns'),
                resources: require('./routes/forage.routes.api.resources')
            };
