...
(function () {
    ...
    HTTPRoutes = function () {
        ...
        this.primaryIndex = function (request, response) {
            ...
            Forage.HTTPServer.router.set('partials', {body: "documentation"});            
        ...
        this.login = function (request, response) {
            ...
            // Load the view
            Forage.HTTPServer.router.set('partials', {body: "login"});
        ...
        this.register = function (request, response) {
            ...
            // Load the view
            Forage.HTTPServer.router.set('partials', {body: "register"});
...
//****************************************************************//
            ...
            // Load the view
            Forage.HTTPServer.router.set('partials', {body: "dashboard"});
        ...
        this.loginAttempt = function (request, response) {
            ...
            Forage.players.validateCredentials(request.body.email, request.body.password)
					    ...
					    .then(function (player){
					        ...
					        Forage.players.createSession(request, player)
    					        .then(function (player) {
        					        ...
        					        Forage.notify('Logging in ' + request.session.player.email);
                ...
                // Upon failure to validate credentials, set a session error and redirect to the login page
                    ...
                    Forage.notify('Error logging somebody in with the email ' + request.body.email);
                    response.location('/login');
					response.redirect('/login');
        ...
        this.registerAttempt = function (request, response) {
            ...
            if (request.body.email.toString().trim() === '' || request.body.password.toString().trim() === '') {
                ...
                Forage.notify('missing elements');
        			            ...
        			            .then(function (player) {
        			                ...
        			                Forage.players.createSession(request, player)
        				                ...
        				                .then(function (player) {
        				                    ...
        				                    // Notify anybody watching the development environment
            				                Forage.notify('Player created, redirecting to dashboard');
            						        response.location('/dashboard');
                							response.redirect('/dashboard');
...
//****************************************************************//
            ...
            if (!request.session.player.is_admin) {
                response.location('/dashboard');
                response.redirect('/dashboard');
            }
//****************************************************************//
            ...
            // Load the view
            Forage.HTTPServer.router.set('partials', {body: "admin"});
