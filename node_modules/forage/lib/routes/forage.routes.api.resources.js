...
(function () {
    ...
    APIResourcesRoutes = function () {
        ...
        this.listActive = function (request, response) {
            ...
            if (!request.session.player) {
                ...
                game = Forage.games.findById(request.session.player.game);
                game[0].listResources()
                    .then(function (activeResources) {
                        response.result = activeResources;
                        response.render();
                    }, console.log);
        ...
        this.getById = function (request, response) {
            ...
            games[0].resourcesById(request.params._id)
                .then(function (foundResources) {
                        response.result = foundResources;
                        response.render();
                    }, console.log);
        };
    ...
    APIResourcesRoutes = new APIResourcesRoutes();
    
}());

module.exports = APIResourcesRoutes;