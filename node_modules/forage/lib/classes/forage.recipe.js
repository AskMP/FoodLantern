    ...
    Recipe = function (recipeData) {
        ...
        this.save = function () {
            ...
            if (self._id === '') {
                ...
                Forage.MongoServer.models.recipe.create(newData, function (err, newRecipe) {
                    if (err) {
                        console.log(err)
                    } else {
                ...
                Forage.MongoServer.models.recipe.update({ _id : self._id }, { $set : newData }, function (err, numberAffected, raw) {
                    if (err) {
                        console.log(err);
                    }
