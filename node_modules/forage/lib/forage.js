...
(function () {
    ...
    Forage = function () {
        ...
        this.settings       = {
            ...
            speed   : 1,
            db      : 'Forage',    // MongoDB database name
        ...
        this.initialize = function (settings) {
            ...
            self.MongoServer.initialize()
                ...
                .then(self.SocketServer.setupServerListeners, console.log)
                // Setup the models
        ...
        this.loadModels = function () {
            ...
            self.games = require('./models/forage.games');
            
            // Player logic and control
            self.players = require('./models/forage.players');
