...
(function () {
    ...
    APIRecipesRoutes = function () {
        ...
        this.listActive = function (request, response) {
            ...
            if (!request.session.player) {
                ...
                game = FoodLantern.games.findById(request.session.player.game);
                game[0].listRecipes()
                    .then(function (activeRecipes) {
                        response.result = activeRecipes;
                        response.render();
                    }, console.log);
            }
        ...
        this.getById = function (request, response) {
            ...
            games[0].recipesById(request.params._id)
                .then(function (foundRecipes) {
                        response.result = foundRecipes;
                        response.render();
                    }, console.log);
        };
    ...
    APIRecipesRoutes = new APIRecipesRoutes();
    
}());

module.exports = APIRecipesRoutes;