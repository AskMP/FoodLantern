...
(function () {
    ...
    Lantern = function (lanternData) {
        ...
        this.initialize = function (lanternData) {
            ...
            lanernData = JSON.parse(JSON.stringify(lanernData));
        ...
        this.save = function () {
            ...
            if (self._id === '') {
                ...
                FoodLantern.MongoServer.models.lantern.create(newData, function (err, newLantern) {
                    if (err) {
                        console.log(err)
                    } else {
                ...
                FoodLantern.MongoServer.models.lantern.update({_id : self._id}, { $set : newData}, function (err, numberAffected, raw) {
                    if (err) {
                        console.log(err);
                    }
