    ...
    Resource = function (resourceData) {
        ...
        this.save = function () {
            ...
            if (self._id === '') {
                ...
                FoodLantern.MongoServer.models.resource.create(newData, function (err, newResource) {
                    if (err) {
                        console.log(err)
                    } else {
                ...
                FoodLantern.MongoServer.models.resource.update({ _id : self._id }, { $set : newData }, function (err, numberAffected, raw) {
                    if (err) {
                        console.log(err);
                    }
