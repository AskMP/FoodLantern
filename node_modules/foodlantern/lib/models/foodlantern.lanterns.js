    ...
    lanterns = function () {
        ...
        this.loadAll = function (lanterns, index) {
            ...
            if (index === lanterns.length) {
                ...
                FoodLantern.notify('Loading lantern ' + (index + 1) + ' of ' + lanterns.length);
        ...
        this.load = function (lanternData) {
            ...
            FoodLantern.notify('Added lantern ' + newLantern.name + ' to game as ID: ' + newLantern._id);
